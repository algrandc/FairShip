...
enum DetectorId {kVETO, kTimeDet, kEmShield, kSensVollarge, ktauRpc, ktauHpt, ktauTT, ktauTarget, kStraw, kecal, khcal, kMuon ,kPreshower,kTRSTATION, kSplitCal, kBox1, kSpectrometer, kScintillator, kMufluxSpectrometer, kMuonTagger, kEndOfList};
