...
#    c.NuTauTarget.nuTargetPassive = nuTargetPassive
    c.NuTauTarget.nuTargetPassive = 0 #######I changed it to have an active volume
...
print "Emulsion region X: ",c.NuTauTarget.xdim,", Y: ",c.NuTauTarget.ydim,", Z: ",c.NuTauTarget.zdim
...
#c.EmShield.xSize1=2*u.m
#c.EmShield.ySize1=3.5*u.m
#c.EmShield.zSize1=20.*u.cm
#c.EmShield.xCenter1=0.*u.m
#c.EmShield.yCenter1=0.*u.m
#c.EmShield.zPos1=-25.06*u.m
#if emdesign ==1:
#c.EmShield  =  AttrDict(z=-34.88*u.m)
#c.EmShield.xSize2=2.5*u.m
#c.EmShield.ySize2=3.5*u.m
#c.EmShield.zSize2=20.*u.cm
...
#c.EmShield.zSize1=0.*u.cm #max is 22cm (between -35 and -34.78)
...
#For the hourglass shape after parametrisation
c.emrectheight=emrectheight
c.emtrapheight=emtrapheight
c.emthick=emthick
c.emtrapwidth=emtrapwidth
c.emdensity=emdensity
c.emwidth=emwidth

c.EmShield  =  AttrDict(z=0*u.m) 
c.EmShield.trapreg=emtrapheight*u.cm
c.EmShield.xSize1=emwidth*u.cm # -35 one
c.EmShield.ySize1=2*emrectheight*u.cm+emtrapheight*u.cm
c.EmShield.zSize1=emthick*u.mm #max is 22cm (between -35 and -34.78)
c.EmShield.zPos1=0.5*(c.EmuMagnet.zC-c.EmuMagnet.Z/2.-c.decayVolume.length/2.-c.muShield.LE) #should center it between EmuMagnet and muShield (-34.89m in the current design)
c.EmShield.xtrap1=emtrapwidth*u.cm ###


print "a: ",(c.EmShield.ySize1-c.EmShield.trapreg)/2,", b: ",c.EmShield.xSize1,", c: ",c.EmShield.trapreg,", d: ",c.EmShield.xtrap1,", z: ",c.EmShield.zSize1



#(thickness set to 0=> doesn't matter
...
c.SensVollarge  =  AttrDict(z=0*u.m) 
c.SensVollarge.xSize2=c.EmShield.xSize1 + 2.*u.m #-25 one
c.SensVollarge.ySize2=c.EmShield.ySize1 + 2.*u.m 
c.SensVollarge.zSize2=0.1*u.cm
c.SensVollarge.xCenter2=0.*u.m
c.SensVollarge.yCenter2=0.*u.m
c.SensVollarge.zPos2=c.EmShield.zPos1
c.SensVollarge.totallength=c.EmShield.zSize1
c.SensVollarge.spacing=c.EmShield.zSize1
