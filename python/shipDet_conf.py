...
# ---- for backward compatibility ----
 ...
 latestShipGeo = ConfigRegistry.loadpy("$FAIRSHIP/geometry/geometry_config.py",Yheight = ship_geo.Yheight/u.m, tankDesign = ship_geo.tankDesign, muShieldDesign = ship_geo.muShieldDesign, nuTauTargetDesign = ship_geo.nuTauTargetDesign,emrectheight=ship_geo.emrectheight,emwidth=ship_geo.emwidth,emtrapwidth=ship_geo.emtrapwidth, emtrapheight=ship_geo.emtrapheight,emthick=ship_geo.emthick, emdensity=ship_geo.emdensity)
# -----Create media-------------------------------------------------
...
#-----   EmShield ---------------------------------------------------------------------
 ...
 emShield = ROOT.EmShield("EmShield", ROOT.kTRUE)
 emShield.SetSizeX1(ship_geo.EmShield.xSize1)
 ...
 emShield.SetZposition2(ship_geo.EmShield.zPos2)

 detectorList.append(emShield)


 sensvollarge = ROOT.SensVollarge("SensVollarge", ROOT.kTRUE)
 sensvollarge.SetSizeX2(ship_geo.SensVollarge.xSize2)
 sensvollarge.SetSizeY2(ship_geo.SensVollarge.ySize2)
 sensvollarge.SetSizeZ2(ship_geo.SensVollarge.zSize2)
 sensvollarge.SetZposition2(ship_geo.SensVollarge.zPos2)
 sensvollarge.SetLength(ship_geo.SensVollarge.totallength)
 sensvollarge.SetSpacing(ship_geo.SensVollarge.spacing)

 detectorList.append(sensvollarge)
