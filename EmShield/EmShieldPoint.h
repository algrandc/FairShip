#ifndef EMSHIELDPOINT_H
#define EMSHIELDPOINT_H 1
...
class EmShieldPoint : public FairMCPoint
{
  ...
  public:
     ...
     **/
    EmShieldPoint(Int_t trackID, Int_t detID, TVector3 pos, TVector3 mom,
                     Double_t tof, Double_t length, Double_t eLoss, Int_t pdgCode, TVector3 Lpos, TVector3 Lmom);

    /** Destructor **/
    virtual ~EmShieldPoint();
  ...
  private:
    ...
    EmShieldPoint(const EmShieldPoint& point);
    EmShieldPoint operator=(const EmShieldPoint& point);

    ClassDef(EmShieldPoint,1)
